...
var repoIssuesUrl = "https://api.github.com/repos/solomy/blog_commnt/issues";
// 对应仓库 clientId、clientSecret 关于这两个参数的安全问题，查看 https://removeif.github.io/2019/09/19/博客源码分享.html#1-热门推荐，最新评论：
var clientId = "9f2798b49b62f45feaf0";
var clientSecret = "8c5d9e804d381a63747232bc6577ac79bd3a6acc";
...
$(document).ready(setTimeout(function () { // 延迟1s执行，保证其余的先加载
        ...
        if (COMMENT_CACHE == '' || COMMENT_CACHE == null || new Date().getTime() - COMMENT["date"] > 60 ) { // request per 10 minutes
        ...
        console.log("~~~~记得有时间多来看看哦，https://solomy.github.io/")
    }
    ,
    500
))
